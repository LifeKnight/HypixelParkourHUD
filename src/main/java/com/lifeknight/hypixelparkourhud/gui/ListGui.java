...
import com.lifeknight.hypixelparkourhud.variables.LifeKnightList;
...
public class ListGui extends GuiScreen {
    ...
    public void initGui() {
        ...
        addField = new LifeKnightTextField(1, getScaledWidth(75), getScaledHeight(85), getScaledWidth(150), 20, lifeKnightList.getName()) {
            @Override
            public void handleInput() {
